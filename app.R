...
#setwd("~/Dropbox (iDiv)/DESIRE_AMIM/Paper/2nd_Submission_NATURE/Data_work/2_Analysis")
#runApp("shiny")
  ...
  sidebarLayout(
    ...
    sidebarPanel(position = "right",
                 fluidRow(selectInput("bins2", h5("Total impacts and their decomposition into the contribution of population, GDP per capita and impact per GDP."), 
                                      choices = list("Impacts" = df43$impacts), selected = 1)),
                 fluidRow(selectInput("bins", h5(""), 
                                      choices = list("Region" = df43$WR), selected = 1)),
